  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section id="accueil" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* Overlays */}
        <div className="absolute inset-0 bg-midnight-purple/85"></div>
        <div className="absolute inset-0 bg-gradient-to-br from-midnight-purple/90 via-purple-800/80 to-indigo-900/90"></div>
            ...
            {services.map((service, index) => (
              ...
              >
                <motion.div
                  ...
                  className="relative rounded-3xl bg-white shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-500 overflow-hidden h-full"
                >
                  {/* Service Image */}
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <div className="absolute top-6 left-6">
                      <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white/20 backdrop-blur-sm text-2xl shadow-lg`}>
                        {service.icon}
                      </div>
                    </div>
                  </div>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-midnight-purple/90"></div>
        <div className="absolute inset-0 bg-gradient-to-r from-midnight-purple/95 to-indigo-900/95"></div>
                  ...
                  <div className="flex items-center justify-center space-x-6">
                    <div className="relative">
                      <img 
                        ...
                        className="w-20 h-20 rounded-full object-cover border-4 border-brand/20"
                      />
                      <div className="absolute inset-0 rounded-full bg-gradient-to-br from-brand/20 to-purple-500/20"></div>
                    </div>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-midnight-purple/90"></div>
        <div className="absolute inset-0 bg-gradient-to-br from-midnight-purple/95 via-purple-800/90 to-indigo-900/95"></div>

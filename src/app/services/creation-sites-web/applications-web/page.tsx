        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden lg:flex space-x-8">
              ...
              <Link href="/services/creation-sites-web" className="text-gray-700 hover:text-gray-900 transition-colors font-medium">Sites Web</Link>
              <span className="text-gray-900 font-semibold">Applications Web</span>
            </div>
            <motion.button 
      ...
      <footer className="bg-gray-900 text-white py-16 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-lg leading-relaxed text-gray-300 mb-6 max-w-md">
                Experts Applications Web au Luxembourg. 
                Solutions sur mesure, performance garantie.
              </p>
            </div>
            <div>
              <h5 className="text-white mb-4 font-bold">Applications Web</h5>
              <ul className="space-y-2 text-gray-300">
                <li><a href="#" className="hover:text-brand transition-colors">CRM Sur Mesure</a></li>
                <li><a href="#" className="hover:text-brand transition-colors">Plateformes SaaS</a></li>
                <li><a href="#" className="hover:text-brand transition-colors">Systèmes Intégrés</a></li>
                <li><Link href="/services/creation-sites-web" className="hover:text-brand transition-colors">Sites Web</Link></li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Wedid. Tous droits réservés. | Applications Web Luxembourg</p>
          </div>
        </div>
      </footer>
    </div>

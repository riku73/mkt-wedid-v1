        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden lg:flex space-x-8">
              ...
              <span className="text-gray-900 font-semibold">E-commerce</span>
            </div>
            <motion.button 
      ...
      <footer className="bg-gray-900 text-white py-16 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-lg leading-relaxed text-gray-300 mb-6 max-w-md">
                Experts E-commerce au Luxembourg. 
                Boutiques performantes, ventes maximisées.
              </p>
            </div>
            <div>
              <h5 className="text-white mb-4 font-bold">E-commerce</h5>
              <ul className="space-y-2 text-gray-300">
                <li><a href="#" className="hover:text-brand transition-colors">Shopify Plus</a></li>
                <li><a href="#" className="hover:text-brand transition-colors">WooCommerce</a></li>
                <li><a href="#" className="hover:text-brand transition-colors">Solutions Custom</a></li>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Wedid. Tous droits réservés. | E-commerce Luxembourg</p>
          </div>
        </div>
      </footer>
    </div>

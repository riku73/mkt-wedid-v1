      ...
      <footer className="bg-gray-900 text-white py-16 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2">
              ...
              <p className="text-lg leading-relaxed text-gray-300 mb-6 max-w-md">
                L'agence consulting de référence au Luxembourg. 
                Expertise métier, accompagnement personnalisé.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li><Link href="/services/consulting-formation/strategie-digitale" className="hover:text-brand transition-colors">Stratégie Digitale</Link></li>
                <li><Link href="/services/consulting-formation/formation-equipes" className="hover:text-brand transition-colors">Formation Équipes</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li><a href="#" className="hover:text-brand transition-colors">Études de cas</a></li>
                <li><a href="#" className="hover:text-brand transition-colors">Méthodologie</a></li>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Wedid. Tous droits réservés. | Consulting Digital Luxembourg</p>
          </div>
        </div>
      </footer>
    </div>
